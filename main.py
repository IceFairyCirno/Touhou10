...
bullets=[]
reimu_frames = get_sprite_frames(sprite_sheet, 16, 16, 32, 48, 8)
    
while running:

    screen.blit(background, (0, 0))
    screen.blit(reimu_frames[0], ((FIELD_WIDTH//2)+31-(31//2), 70-(41//2))) #enemy
    ...
    if frame_timer >= 10:
        frame_timer = 0
        current_frame = (current_frame + 1) % len(reimu_frames)
    screen.blit(reimu_frames[current_frame], player_pos)
